    ...
    <div className="overlay-content relative w-full h-full flex flex-col justify-center max-w-7xl mx-auto px-6 md:px-12 pointer-events-none">
      ...
      >
        <div className="flex flex-col items-center md:items-end">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-black/60 border border-white/10 backdrop-blur-md shadow-lg mb-4">
            <span className="w-2 h-2 rounded-full bg-orange-500 animate-ping" />
            <span className="text-[11px] font-mono tracking-[0.25em] text-orange-400 font-bold uppercase">
              Portfolio &apos;26 // Creative Dev
            </span>
          </div>

          {/* Main Title - Pure White & Vibrant Orange in Cinzel font */}
          <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-[8rem] font-bold tracking-tight font-cinzel drop-shadow-[0_12px_40px_rgba(0,0,0,0.9)] leading-[0.95]">
            <span className="text-white">Ayush</span> <span className="text-orange-500">Kodle</span>
          </h1>

          {/* Tagline */}
          <p className="mt-4 md:mt-6 text-base sm:text-xl md:text-2xl text-neutral-200 tracking-[0.2em] md:tracking-[0.35em] uppercase font-medium max-w-2xl font-space">
            Crafting <span className="text-orange-500 font-cinzel normal-case italic font-bold">tactile</span> digital experiences
          </p>

          {/* Scroll Prompt */}
          <div className="mt-10 flex items-center gap-3 font-mono text-xs text-white/70 tracking-[0.25em] uppercase animate-pulse">
      ...
      >
        ...
        >
          ...
          {/* HUD Section Tag */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 font-mono text-[10px] uppercase tracking-[0.2em] text-orange-400 mb-6">
            <span>01</span>
            <span className="text-white/30">//</span>
            <span>Vision</span>
          </div>

          <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white leading-[1.1] font-cinzel">
            Building digital <br className="hidden sm:block" />
            <span className="text-orange-500">experiences</span> with <br />
            depth &amp; purpose.
          </h2>

          <p className="mt-6 text-sm md:text-base text-neutral-200 font-light leading-relaxed max-w-lg font-space">
      ...
      >
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white leading-[1.1] font-cinzel">
            Bridging <span className="text-orange-500">design</span> <br />
            &amp; engineering.
          </h2>

          <p className="mt-6 text-sm md:text-base text-neutral-200 font-light leading-relaxed max-w-lg ml-auto">
            Architecting robust frontend infrastructure paired with micro-animations, claymorphism, and modern web standards.
          </p>

          <div className="mt-8 flex items-center justify-end gap-2 font-mono text-xs text-orange-400 tracking-widest uppercase font-semibold">
      ...
      >
        <div className="px-6 py-2 rounded-full bg-black/60 border border-white/10 backdrop-blur-md text-white font-mono text-xs uppercase tracking-[0.3em] flex items-center gap-3 shadow-lg">
