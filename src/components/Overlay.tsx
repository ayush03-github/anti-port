    ...
    <div className="relative w-full h-full flex flex-col justify-center max-w-7xl mx-auto px-6 md:px-12 pointer-events-none">
      ...
      >
        <div className="flex flex-col items-center md:items-end">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1e1e1e]/80 dark:bg-[#1e1e1e]/80 light:bg-white/80 border border-white/10 dark:border-white/10 light:border-black/10 backdrop-blur-md shadow-lg mb-4">
      ...
      >
        <div className="relative max-w-2xl bg-[#141414]/70 dark:bg-[#141414]/70 light:bg-white/80 backdrop-blur-2xl p-8 md:p-12 rounded-[2.5rem] border border-white/10 dark:border-white/10 light:border-slate-200/80 shadow-2xl transition-colors duration-300">
          {/* Accent Glow Blob */}
          <div className="absolute -top-10 -left-10 w-32 h-32 bg-[#f5e156]/10 blur-3xl rounded-full pointer-events-none" />

          {/* HUD Section Tag */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 dark:bg-white/5 light:bg-slate-100 border border-white/10 dark:border-white/10 light:border-slate-200 font-mono text-[10px] uppercase tracking-[0.2em] text-[#f5e156] dark:text-[#f5e156] light:text-amber-600 mb-6">
            <span>01</span>
      ...
      >
        <div className="px-6 py-2 rounded-full bg-black/40 dark:bg-black/40 light:bg-white/90 border border-white/10 dark:border-white/10 light:border-slate-200 backdrop-blur-md text-neutral-400 dark:text-neutral-400 light:text-slate-700 font-mono text-xs uppercase tracking-[0.3em] flex items-center gap-3 shadow-lg transition-colors duration-300">
